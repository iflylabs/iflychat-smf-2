...
// iFlyChat START //
  ...
  $txt['permissionname_user_iflychatshow'] = 'Access iFlyChat';
  $txt['permissionhelp_user_iflychatshow'] = 'Allows a user to access iFlyChat.';
  $txt['permissionname_user_iflychatpage'] = 'Administer iFlyChat';
  $txt['permissionhelp_user_iflychatpage'] = 'Allows a user to administer iFlyChat.';
